...
public class JumpOnTop : MonoBehaviour {
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        //Si el objeto con el que se ha colisionado es el jugador y "angle" es practicamente 0 sabemos que la colisión ha sido por arriba.
         if (collision.gameObject.tag == "Player" && angle < 0.01&&transform.position.y<=collision.transform.position.y)
         {
